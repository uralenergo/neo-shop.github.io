...
<li><a href="index.php?sort=title">По алфавиту</a></li>
</ul>
</li>
</ul>
</div>
...
<?php
    $count = mysql_query("SELECT COUNT (*) WHERE title LIKE '%$search%' AND visible = '1'",$link);
	$result = mysql_query("SELECT * FROM table_products WHERE title LIKE '%$search%' AND visible='1' ORDER BY $sorting",$link);
